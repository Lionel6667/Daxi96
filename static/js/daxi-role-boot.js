(() => {
  ...
  // capacitor-src/role-boot.js
  var require_role_boot = __commonJS({
    "capacitor-src/role-boot.js"(exports) {
      (function(global) {
        "use strict";
        function onReady(fn) {
        ...
        function reinitDriver() {
          ...
          try {
            ...
            var key = global.DJANGO_SESSION && global.DJANGO_SESSION.google_maps_key || global.GOOGLE_MAPS_API_KEY || "";
